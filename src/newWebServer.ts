...
export interface WebServerConfig {
    worker:string, port:number, crossOriginHeaders?:string, serverName?:string, maxBodySize?:number/**MB*/, maxHeadersCount?:number,
    mods?:{[index:string]:any}, global?:any,
    dir?:string,numbers?:number/**mult_thread*/,backlog?:number,
    globalKey?:string,
    logMore?:boolean
}

export function getServerOpts(cfg:WebServerConfig, optsDefault={serverName:"nginx",maxHeadersCount:32,maxBodySize:16}):{[index:string]:number|string} {
